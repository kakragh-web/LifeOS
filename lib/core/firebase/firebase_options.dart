...
//
// Do NOT commit real API keys. Use environment variables or
...
class DefaultFirebaseOptions {
  ...
  // ─── Replace all placeholder values below with output from `flutterfire configure` ───
