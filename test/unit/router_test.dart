...
WidgetHarness makeApp(
  ...
  const manifestCodec = StandardMessageCodec();
  final Object? encodedManifest =
      manifestCodec.encodeMessage(<Object?, Object?>{});
...
void main() {
  ...
  group('Router redirect flow', () {
    testWidgets('unauthenticated user at splash → welcome', (tester) async {
      final harness = makeApp(tester, const AsyncData<AppUser?>(null));
